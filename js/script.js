...
document.getElementById('contactForm').addEventListener('submit', (e) => {
    submitToWeb3Forms(e, () => alert('Thank you for your message! I will respond within 24 hours.'));
});
...
document.getElementById('tournamentForm').addEventListener('submit', (e) => {
    submitToWeb3Forms(e, () => { formWrap.style.display = 'none'; successDiv.style.display = 'block'; setTimeout(closeModal, 5000); });
});
